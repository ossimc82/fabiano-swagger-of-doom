        ...
        priavte wServer.logic.BehaviorDb.priavte wServer.logic.BehaviorDb._ Avatar = () => wServer.logic.BehaviorDb.Behav()
            .Init("shtrs Defense System",
                new wServer.logic.State(
                    ...
                    new ChangeGroundOnDeath(new[] { "Pure Evil" }, new[] { "shtrs Disaster Floor", "shtrs Shattered Floor" },
                        30),
                    new wServer.logic.State("spiral",
                        new SetAltTexture(0),
                    ...
                    new wServer.logic.State("spiral2",
                        new SetAltTexture(0),
                    ...
                    new wServer.logic.State("spiral3",
                        new SetAltTexture(0),
            ...
            .Init("shtrs Pillar 1",
                new wServer.logic.State(
                    ...
                    new wServer.logic.State("preparing",
